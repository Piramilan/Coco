...
const Predictions = ({ url }) => {
  ...
  let imageModelURL =
    'https://teachablemachine.withgoogle.com/models/XDM6smNtb/';
  ...
  useEffect(() => {
    const classifyImg = () => {
      // classifier.then((res) => console.log(res));
      // console.log(classifier, "Call");
  ...
  //   const classifier = ml5
  //     .imageClassifier(imageModelURL + "model.json")
  //     .then((res) =>
  //       console.log(
  //         res.predict(img, 5, function (err, res) {
  //           console.log(res, "Res");
  //           return res;
  //         })
  //       )
  ...
  //     })
  //     .then(function (result) {
  //       // classifier.then((res) => res.mapStringToIndex);
  //       console.log(result); // "secondPromise"
  //     });
  // }, []);

  return (
    <div className='flex flex-col lg:flex-row justify-center lg:justify-evenly lg:space-x-8 items-center'>
        ...
        <div className='flex flex-col justify-center items-center max-w-[80vw] md:max-w-[500px] mx-auto text-xl'>
          <div className='my-4'>
            <p className='text-center text-3xl'>
              ...
              {covertPercentage(result[0]?.confidence)}% This is{' '}
              {result[0]?.label}
            </p>
          </div>
